        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-32 pb-16 lg:mt-0">
          ...
          <div className="text-center mb-20">
            <div>
              ...
              <div 
                ...
                className="inline-flex items-center gap-2 bg-[#EE7B30]/10 border border-[#EE7B30]/30 rounded-full px-4 py-2 backdrop-blur-sm mb-8"
              >
              ...
              <p 
                ...
                data-aos-delay="150"
                data-aos-duration="800"
                className="text-[#C9D1D9] text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed mb-12"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-20">
            ...
            <div 
              ...
              data-aos-delay="400"
              data-aos-duration="800"
              className="group bg-gradient-to-br from-[#F9F6F1]/10 to-[#F9F6F1]/5 backdrop-blur-xl rounded-3xl p-10 border border-[#C9D1D9]/20 hover:border-[#EE7B30]/50 transition-all duration-500 hover:scale-105 hover:shadow-[0_0_50px_rgba(238,123,48,0.3)]"
            >
              <div 
                data-aos="zoom-in"
                data-aos-delay="450"
                data-aos-duration="600"
                className="w-16 h-16 bg-gradient-to-br from-[#EE7B30] to-[#EE7B30]/70 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500"
              >
              ...
              {values.map((value, index) => (
                ...
                >
                  <div 
                    ...
                    data-aos-duration="600"
                    className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-[#EE7B30] to-[#EE7B30]/70 flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-500"
                  >
          ...
          <div className="mt-20 text-center">
            <div 
              ...
              data-aos-delay="900"
              data-aos-duration="800"
              className="bg-gradient-to-br from-[#F9F6F1]/10 to-[#F9F6F1]/5 backdrop-blur-xl rounded-3xl p-12 border border-[#C9D1D9]/20"
            >
              <Award 
                data-aos="zoom-in"
                data-aos-delay="950"
